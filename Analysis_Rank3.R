...
treateff_hdl   <- -0.6897 # Treatment effect on HDL-cholesterol (absolute effect, which unit??)
treateff_ldl   <- -8.77 # Treatment effect on LDL-cholesterol (absolute effect, which unit??)

# # Treatment effects currently not in use
# treateff_bmi <- -0.1268 # Treatment effect on BMI (in absolute points)
# treateff_sbp <- -8.5678 # Treatment effect on SBP (in absolute mmHg)
# treateff_QoL
