...
treateff_hdl   <- 5.4857 # Treatment effect on HDL-cholesterol (absolute effect, which unit??)
treateff_ldl   <- -11.9313 # Treatment effect on LDL-cholesterol (absolute effect, which unit??)

# # Treatment effects currently not in use
# treateff_bmi <- 0 # Treatment effect on BMI (in absolute points)
# treateff_sbp <- 0 # Treatment effect on SBP (in absolute mmHg)
# treateff_QoL
