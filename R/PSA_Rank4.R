...
draws.hba1c <- rpert(n_psa_input, min = -0.9703, mode = -0.7037, max = -0.2303)
draws.hdl <- rpert(n_psa_input, min = -0.5365, mode = 8, max = 16.5365)
draws.sbp <- rpert(n_psa_input, min = -11.3451, mode = -4.8379, max = 1.6693)
