...
draws.hba1c <- rpert(n_psa_input, min = -1.1101, mode = -0.5616, max = -0.0131)
draws.sbp <- rpert(n_psa_input, min = -17.8715, mode = -10.5144, max = -3.1574)
