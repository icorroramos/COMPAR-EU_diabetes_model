...
print(paste(end, 'End of Rank 5 analysis'))
print('Duration of Rank 5 analysis')
print(end-init)
...
save(sim.vars,
     sim.results.female,
     sim.results.male,
     file = paste0('output/', country.id, '/Rank5_basecase_', npats_input, '-pats_seed-', seed_input, '.RData'))
