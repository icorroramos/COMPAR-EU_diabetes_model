...
baseline_characteristics <- read.csv("input/UK/baseline_characteristics_UK_rank_2_study_pop.csv", sep=",")
...
treateff_hba1c <- -1.07 # Treatment effect on HbA1c (in absolute %-points HbA1c)
...
save(sim.vars,
     ...
     file = 'output/Rank2_spec_targetpop.RData') #
