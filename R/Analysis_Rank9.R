...
treateff_hba1c <- -1.0186 # Treatment effect on HbA1c (in absolute %-points HbA1c)
...
treateff_bmi <- -1.3698 # Treatment effect on BMI (in absolute points)
...
print(paste(end, 'End of Rank 9 analysis'))
print('Duration of Rank 9 analysis')
print(end-init)
...
save(sim.vars,
     sim.results.female,
     sim.results.male,
     file = paste0('output/', country.id, '/Rank9_basecase_', npats_input, '-pats_seed-', seed_input, '.RData'))
