...
draws.hba1c <- rpert(n_psa_input, min = -0.3479, mode = -0.168, max = 0.012)
draws.hdl <- rpert(n_psa_input, min = -2.5082, mode = -0.2707, max = 1.9668)
draws.ldl <- rpert(n_psa_input, min = -5.9207, mode = -2.9532, max = 0.0143)
draws.bmi <- rpert(n_psa_input, min = -1.6431, mode = -0.8438, max = -0.0445)
draws.sbp <- rpert(n_psa_input, min = -8.002, mode = -4.2854, max = -0.5688)
