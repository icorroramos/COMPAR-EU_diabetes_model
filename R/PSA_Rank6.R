...
draws.hba1c <- rpert(n_psa_input, min = -1.1772, mode = -0.7037, max = -0.2303)
draws.hdl <- rpert(n_psa_input, min = -1.963, mode = 3.867, max = 9.697)
draws.ldl <- rpert(n_psa_input, min = -17.4028, mode = -6.1872, max = 5.0284)
draws.bmi <- rpert(n_psa_input, min = -1.6675, mode = -0.12, max = 1.4275)
draws.sbp <- rpert(n_psa_input, min = -9.4385, mode = -1.7, max = 6.0385)
