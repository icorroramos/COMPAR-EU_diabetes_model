...
draws.hba1c <- rpert(n_psa_input, min = -2.2902, mode = -1.0186, max = 0.253)
draws.bmi <- rpert(n_psa_input, min = -5.5826, mode = -1.3698, max = 2.8429)
