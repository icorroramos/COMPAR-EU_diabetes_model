...
seed_input <- 1*958 # A random seed that it is used to ensure consistency in the model results.
...
save(sim.vars,
     ...
     file = 'output/TEST_RUN_new_discounted_QALYs_male_1.RData') #file = paste0('output/', comp, '_seed_', seed_input, '.RData')
