...
draws.hba1c <- rpert(n_psa_input, min = -0.9604, mode = -0.5674, max = -0.1745)
draws.hdl <- rpert(n_psa_input, min = -3.5956, mode = -0.6897, max = 2.2162)
draws.ldl <- rpert(n_psa_input, min = -11.0507, mode = -8.77, max = -6.4893)
draws.bmi <- rpert(n_psa_input, min = -0.8454, mode = -0.1268, max = 0.5919)
draws.sbp <- rpert(n_psa_input, min = -13.6618, mode = -8.5678, max = -3.4738)
