...
draws.hba1c <- rpert(n_psa_input, min = -0.4405, mode = -0.391, max = -0.3423)
draws.hdl <- rpert(n_psa_input, min = -0.158, mode = 0.268, max = 0.5946)
draws.ldl <- rpert(n_psa_input, min = -3.0185, mode = -1.78, max = -0.5348)
draws.bmi <- rpert(n_psa_input, min = -0.417, mode = -0.283, max = -0.1483)
draws.sbp <- rpert(n_psa_input, min = -2.5936, mode = -2.04, max = -1.4797)
...
save(sim.var.data,
     ...
     file = 'output/PSA_All_SMI_vs_UC_basecase.RData')
