...
treateff_hba1c <- -0.7098 # Treatment effect on HbA1c (in absolute %-points HbA1c)
...
print(paste(end, 'End of Rank 12 analysis'))
print('Duration of Rank 12 analysis')
print(end-init)
...
save(sim.vars,
     sim.results.female,
     sim.results.male,
     file = paste0('output/', country.id, '/Rank12_basecase_', npats_input, '-pats_seed-', seed_input, '.RData'))
