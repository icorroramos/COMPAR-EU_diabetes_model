...
treateff_hdl   <- 8 * 0.02586 * 10 # TRANSFORMATION *10 FOR MODEL INPUT # Treatment effect on HDL-cholesterol (absolute effect in mmol/l)
...
print(paste(end, 'End of Rank 4 analysis'))
print('Duration of Rank 4 analysis')
print(end-init)
...
save(sim.vars,
     sim.results.female,
     sim.results.male,
     file = paste0('output/', country.id, '/Rank4_basecase_', npats_input, '-pats_seed-', seed_input, '.RData'))
